...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#goReport').click(function(e) {
			LoadReport("rounds5WageAction.cfm","#reportForm","#reportResult");
			e.preventDefault();
		});
	});
</script>
					...
					<form method="post" id="reportForm">
						...
						<table border="0" cellpadding="2" cellspacing="0" style="float:left;">
							...
							<tr>
								...
								<td><input type="text" name="mileageallow" value="0.05"></td>
							</tr>
						</table>
						<table border="0" cellpadding="2" cellspacing="0" style="float:left;margin:0 0 0 30px;">
							...
							<tr>
								<td><input type="checkbox" name="pubbonus" value="1" id="pubbonus"><label for="pubbonus">+1p per publication</label></td>
							</tr>
							<tr>
								<td><input type="checkbox" name="dropbonus" value="1" id="dropbonus"><label for="dropbonus">+1p per drop</label></td>
							</tr>
							<tr>
								<td><input type="checkbox" name="mileagebonus" value="1" id="mileagebonus"><label for="mileagebonus">+Round mileage allowance</label></td>
							</tr>
						</table>
						<div class="clear"></div>
					</form>
