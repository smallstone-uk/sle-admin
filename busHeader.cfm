...
<cfoutput query="QHeader">
	<table class="compTable">
		...
		<tr><td class="compAddr">#cltTown#</td><td class="compDetailTitle">#cltTelTitle3#</td><td class="compDetail">#cltTel3#</td></tr>
		<tr><td class="compAddr">#cltCounty#</td><td class="compDetailTitle">Website</td><td class="compDetail">#cltWebSite#</td></tr>
		<tr><td class="compAddr">#cltPostcode#</td><td class="compDetailTitle">EMail</td><td class="compDetail">#cltMailOffice#</td></tr>
	</table>
</cfoutput>
