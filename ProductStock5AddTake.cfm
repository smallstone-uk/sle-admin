...
<p>ProductStock5Add.cfm</p>

<cfdump var="#form#" label="" expand="yes" format="html" 
	output="#application.site.dir_logs#ADD-#DateFormat(Now(),'yyyymmdd')#-#TimeFormat(Now(),'HHMMSS')#.htm">
	...
	<cffunction name="AddRecords" access="public" returntype="struct">
		...
		<cftry>
			...
			<cfset loc.result.items = args.siQtyItems>
			...
			<cfset loc.result.StockItemID = loc.QAddBarcodeResult.generatedkey>
