...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/newsReports.css"><!--- accounting report styles --->
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$.getScript('scripts/newsReports.js',function(){});		<!--- load when DOM ready otherwise code won't run --->
