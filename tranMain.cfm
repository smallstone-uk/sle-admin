...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('input[name="tranRef"]').focus(); // Debug
	});
</script>
</head>
						...
						<tr>
							...
							<td>
								<select name="accountID" data-placeholder="Select..." id="account">
									...
									<option value="#item.accID#" <!---DEBUG---><cfif item.accName eq "Booker Limited">selected="selected"</cfif>>#item.accName#</option>
									</cfloop>
								</select>
							</td>
							<td align="right">Ref</td>
							<td><input type="text" size="10" name="tranRef" value="" /></td>
