...
--->		</cfloop>
	...
	<cffunction name="RebuildNomTotals" access="public" returntype="struct" hint="new version 06/12/2014">
		...
		<cftry>		
			<cfquery name="loc.clearTotals" datasource="#loc.datasource#">
			...
			<cfoutput>
				<cfloop query="loc.nominals">
					...
					<cfdump var="#loc.nomItems#" label="loc.nomItems #nomTitle#" expand="no">
					...
					<tr>
						...
						<td>#loc.nomItems.MonthTotal#</td>
					</tr>
					<cfif currentrow gt 2><cfbreak></cfif>
				</cfloop>
			</cfoutput>
			</table>
...
--->		
	...
	<cffunction name="TriggerNominalTotalWipe" access="public" returntype="struct">
		...
		<cfif confirmation eq "start">
			...
			<cfset loc.result = RebuildNomTotals(loc)>
		</cfif>
		<cfreturn loc>
	</cffunction>
