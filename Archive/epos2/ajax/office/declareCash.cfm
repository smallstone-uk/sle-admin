...
<cfoutput>
	<link href="#parm.url#epos2/css/virtualInput.css" rel="stylesheet" type="text/css">
	<link href="#parm.url#epos2/css/sections.css" rel="stylesheet" type="text/css">
	<script src="#parm.url#scripts/jquery-1.11.1.min.js"></script>
	<script src="#parm.url#scripts/jquery-ui.js"></script>
	<script src="#parm.url#epos2/js/virtualInput.js"></script>
	<script src="#parm.url#epos2/js/sections.js"></script>
	<script>
	...
	<body>
		<div class="style_overide">
			<cfinclude template="../getStyleOveride.cfm">
		</div>
		<style>
