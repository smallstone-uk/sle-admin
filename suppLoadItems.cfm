		...
		<cfif ArrayLen(load.items)>
			...
			<table border="1" class="tableList" width="100%">
				...
				<cfloop array="#load.items#" index="item">
					<tr>
						<td width="10"><a href="#item.niID#" class="DeleteItem">X</a>#item.niID#<input type="hidden" name="itemID" id="niID#item.niID#" value="#item.niID#"></td>
						<td>#item.nomTitle#</td>
						<td align="right">#item.nomVATRate#%</td>
						<td align="right">#DecimalFormat(item.niAmount)#</td>
