<cftry>
    ...
    <cfquery name="QData" datasource="#application.site.datasource1#">
            ...
            <cfif StructKeyExists(form,"useNewCode")>
            ...
            <cfif StructKeyExists(form,"roundsTicked")>
            	AND rndID IN (#form.roundsTicked#)
            </cfif>
            <cfif StructKeyExists(form,"useSamples")>AND (ordID < 600 OR ordID IN (7121,591))</cfif>
            <!---AND riRoundID=241 --->
            AND oiStatus='active'
            AND ordActive
            AND pubActive
    ...
    <cfif StructKeyExists(form,"showDumps")><cfdump var="#QData#" label="QData" expand="false"></cfif>
...
<!--- output data --->
					...
					<cfif StructKeyExists(form,"showDumps")><cfdump var="#roundData#" label="roundData 1st pass" expand="false"></cfif>
					<cfoutput>
						<table class="roundList" border="1">
							...
							<cfloop list="#iKeys#" index="key">
								...
								<cfif StructKeyExists(form,"showTrans")>
									<tr>
						...
						<cfif StructKeyExists(form,"showDumps")><cfdump var="#roundData#" label="roundData end" expand="false"></cfif>
