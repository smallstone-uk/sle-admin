...
<cftry>
	...
	<cfoutput>
		...
		<cfif NOT DirectoryExists("#application.site.dir_data#rounds\#DateFormat(parm.form.roundDate,'yy-mm')#")>
			<cfdirectory directory="#application.site.dir_data#rounds\#DateFormat(parm.form.roundDate,'yy-mm')#" action="create">
		</cfif>
		...
		<cfdocument 
			...
			mimetype="text/html"
			saveAsName="#filename#" 
			filename="#application.site.dir_data#rounds\#DateFormat(parm.form.roundDate,'yy-mm')#\#filename#"
			overwrite="yes"
			localUrl="yes" 
			format="PDF" 
			fontEmbed="yes" 
