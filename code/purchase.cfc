	...
	<cffunction name="EndofYearSummary" access="public" returntype="struct">
		...
		<cftry>
            ...
            <cfif len(loc.result.prdTo)>
                ...
                <cfset StructInsert(loc.result.panel,1,{"ID" = 1,"title" = "News Debtors", "group" = "asset", "value" = loc.result.QNewsDebtors.total})>
                ...
                <cfset StructInsert(loc.result.panel,2,{"ID" = 2,"title" = "Trade Creditors", "group" = "liability", "value" = -abs(loc.result.QCreditors.total)})>
               ...
               <cfset StructInsert(loc.result.panel,3,{"ID" = 161,"title" = "Closing Stock", "group" = "asset", "value" = loc.result.QClosingStock.total})>
