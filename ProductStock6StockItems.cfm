<cftry>
	...
	<cfoutput>
		<cfif records.action eq "clear">
			<h1>#records.msg#</h1>
		<cfelse>
			<cfloop query="records.QProdInfo">
				<table class="tableList" border="1" width="100%">
					...
					<tr>
						...
						<td align="center">&pound;#siOurPrice# #records.priceMarked#</td>
			...
			<cfif records.stockitems.recordcount gt 0>
				<table width="100%" border="1" class="tableList">
					<tr>
						...
						<th class="headright">Status</th>
					</tr>
					<cfset totalItems = 0>
					<cfloop query="records.stockItems">
						<cfif siStatus eq 'closed'><cfset totalItems += siQtyItems></cfif>
						<tr>
							<td align="center">#currentrow#</td>
							<td><a href="?id=#siID#&barcode=#parm.form.bcode#" class="deleteItem" data-id="#siID#" data-barcode="#parm.form.bcode#">
								<img src="images/icons/bin_black.png" width="18" height="18" /></a></td>
							<td><a href="?id=#siID#&barcode=#parm.form.bcode#" class="editstock" data-id="#siID#" data-barcode="#parm.form.bcode#">
							...
							<td align="right" class="ourPrice">#siOurPrice# #records.priceMarked#</td>
			...
			<div id="AddStockForm">
				<form name="StockForm" id="StockForm" method="post" enctype="multipart/form-data">
					<input type="hidden" name="productID" id="productID" value="#records.QProdInfo.prodID#" />
					<input type="hidden" name="prodVATRate" id="prodVATRate" value="#records.QProdInfo.prodVATRate#" />
					<!---<input type="hidden" name="barcode" id="barcode" value="#parm.form.bcode#" />--->
					<table border="1" class="tableList3">
						...
						<tr>
							...
							<td width="350"><input type="text" name="siRef" size="15" class="field" value="" tabindex="2" autocomplete="off" /></td>
							<td width="140">VAT Rate</td>
							<td width="350">#records.QProdInfo.prodVATRate#%</td>
						</tr>
						<tr>
							<td>Unit Size</td><td><input type="text" name="siUnitSize" size="10" class="field" value="" tabindex="2" /></td>
							<td>Pack Price</td><td><input type="text" name="siWSP" id="siWSP" size="10" class="price numbersOnly" value="" autocomplete="off" tabindex="8" /></td>
						</tr>
						<tr>
						...
						<tr>
							<td>No. Outer Packs</td><td>
								<input type="text" name="siQtyPacks" id="siQtyPacks" class="itemcount numbersOnly" size="10" value="" autocomplete="off" tabindex="4" />
								<input type="text" name="siQtyItems" id="siQtyItems" disabled="disabled" class="itemcount" size="10" value="" />
							</td>
							<td>RRP</td>
							<td>
								<input type="text" name="siRRP" id="siRRP" size="10" class="price numbersOnly" value="" autocomplete="off" tabindex="10" />
								<label id="prodPriceMarkedLabel" for="prodPriceMarked">#records.QProdInfo.prodPriceMarked#</label>
							</td>
						</tr>
						<tr>
							<td>Purchase Date</td><td><input type="text" name="soDate" id="soDate" size="10" class="datepicker" value="" autocomplete="off" tabindex="5" /></td>
							...
							<td><input type="text" name="suggPrice" id="suggPrice" class="price numbersOnly" disabled="disabled" size="10" value="" tabindex="11" />
								#records.QProdInfo.pgTarget * 100#%</td>
						</tr>
						<tr>
							<td>Expiry Date</td><td><input type="text" name="siExpires" size="10" class="datepickerTo" value="" autocomplete="off" tabindex="6" /></td>
							<td>Our Price</td><td><input type="text" name="siOurPrice" id="siOurPrice" class="price numbersOnly" size="10" value="" autocomplete="off" tabindex="12" /></td>
						</tr>
						<tr>
							<td>Status</td><td>
