...
<cfoutput>
	<div id="tabs">
		...
		<div style="padding:10px 0;">#parm.form.preTranID#</div>
		...
		<table border="1" class="tableList" width="100%">
			<tr>
				...
				<cfif val(parm.form.preTranID) gt 0>
					<td><input type="text" name="trnID" value="#parm.form.preTranID#" id="EditID" tabindex="2"></td>
					<script>
				...
				<td><input type="text" name="trnAmnt1" value="" id="NetAmount" tabindex="5" size="12" class="amount"></td>
			</tr>
			<tr>
				...
				<td><input type="text" name="trnAmnt2" value="" id="VATAmount" tabindex="6" size="12" class="amount"></td>
			</tr>
			<tr>
				...
				<td><input type="text" name="trnTotal" value="" id="GrossTotal" tabindex="7" size="12" class="amount"></td>
			</tr>
			<tr>
