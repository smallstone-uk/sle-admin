			...
			<table border="1" class="tableList" style="font-size:11px;" width="100%">
				...
				<cfloop array="#report.list#" index="i">
					<cfif title neq i.PubID>
						<cfif title neq "">
							<tr><td colspan="12" style="background:##ddd;padding:5px 0;"></td></tr>
						</cfif>
						<cfset title=i.PubID>
						<cfset issue="">
					</cfif>
					<cfif issue neq i.Issue>
						<cfif issue neq "">
							<tr><td colspan="12" style="background:##eee;"></td></tr>
						</cfif>
						<cfset issue=i.Issue>
					</cfif>
					<tr>
				...
				<tr>
					<th colspan="9" align="right" style="font-size:16px;">Totals</th>
