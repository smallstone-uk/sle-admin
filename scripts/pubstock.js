	...
	$.ajax({
		...
		success:function(data){
			$('#LoadPrint').html(data).fadeIn(function() {
				...
				/// Edit - New print preview option if PrintArea print preview is not working ///
				/// Make sure print-area div is outside the wrapper at the bottom of the page, but inside </body></html> /// 
